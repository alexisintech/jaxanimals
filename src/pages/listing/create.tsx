        ...
        <div className="flex w-1/2 flex-col rounded bg-background pb-20 pt-10">
          ...
          {!creating ? (
                  ...
                  <Controller
                    ...
                    render={() => (
                      <>
                        {imageUrl ? (
                          <>
                            {/* Hacky way of submitting the imageUrl to the form */}
                            <Input
                              id="img"
                              value={imageUrl}
                              className="hidden"
            ...
            <div className="px-10 pt-20">
              {/* TO-DO: Add cool loading stuff */}
              {!creationError ? (
                <p>Listing created! Let's show you what it looks like...</p>
              ) : (
                <p>
                  Woops... we weren't able to create your listing at this time.
                  We're sorry *brokenheart*
                </p>
              )}
            </div>
          )}
